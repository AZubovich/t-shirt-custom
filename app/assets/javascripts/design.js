...
var JSONString_Objects;
canvas.setBackgroundImage('https://ae01.alicdn.com/kf/HTB1lYYsRFXXXXXTapXXq6xXFXXXH/GOOD-Quality-5-Color-S-2XL-Plain-T-Shirt-Women-Elastic-Basic-T-shirts-Female-Casual.jpg_640x640.jpg', canvas.renderAll.bind(canvas));
function insertMale(){
  canvas.backgroundImage = null;
  canvas.setBackgroundImage('https://drive.google.com/uc?export=view&id=0B3ubyt3iIvkaUlpHVEpDTGhjQzg', canvas.renderAll.bind(canvas));
}
